<script lang="ts">
	...
	let uploadPSDInput: HTMLElement;
	...
	//handleCustomFont
	const handleCustomFont = async (e: Event): Promise<void> => {
		const target = e.target as HTMLInputElement;
	...
	//handleZoomInput
	const handleZoomInput = (e: Event): void => {
		const target = e.target as HTMLInputElement;
	...
	const handleTemplatesChange = (e: Event): void => {
...
<div class="flex overflow-hidden">
	...
	<input
		...
		class="hidden"
		accept=".psd, .svg"
		on:input={handleUploadPSDInput}
		bind:this={uploadPSDInput}
	/>
	...
	<input
		...
		class="hidden"
		multiple
		on:click={handleMergeSVGFilesInput}
	/>
