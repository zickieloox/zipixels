...
async function handleMergeSVGAndPNG(event, filePaths: string[], width = 0, height = 0) {
...
async function drawGuideLine(svg, svgWidth: number, svgHeight: number, gap: number) {
...
async function divideSVGsIntoGroups(sortedSVGs, totalWidth, maxHeight, gap) {
